...
public static class CatalogData
{
    public static async Task SeedAsync(IServiceProvider services)
    {
        ...
        await products.AddAsync(new ProductDto(0, "Organic Chemistry", "Comprehensive introduction to organic chemistry principles", "TXT-008", 94.99m, 0, 1, new DateTime(2024, 3, 1), new DateTime(2024, 3, 1)));
        ...
        await products.AddAsync(new ProductDto(0, "Organic Chemistry 2", "Comprehensive introduction to organic chemistry 2 principles", "TXT-017", 99.99m, 22, 7, new DateTime(2024, 3, 27), new DateTime(2024, 4, 3)));
        ...
        await products.AddAsync(new ProductDto(0, "Competitive Strategy", "Michael Porter's framework for industry analysis", "TXT-020", 49.99m, 0, 9, new DateTime(2024, 4, 5), new DateTime(2024, 4, 5)));
